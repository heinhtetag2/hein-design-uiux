import svgPaths from "./svg-dzuhz6zxjf";
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex items-end left-[calc(50%-4.5px)] top-1/2" data-name="Frame">
...
function Header3() {
  return (
    <div className="-translate-x-1/2 absolute backdrop-blur-[10px] content-center flex flex-wrap h-[54px] items-center justify-between left-1/2 px-[24px] rounded-[9999px] top-[10px] w-[1440px]" data-name="Header">
      <Menu />
      <Container2 />
      <Frame2 />
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start pt-[140px] relative size-full" data-name="Desktop - 17">
      <Frame4 />
      <IntroSection />
      <Header3 />
    </div>
